  ...
  function slAll(selector) {
   ...
   function getElements() {
        let el = {
            ...
            categoryElements: {
                container: this.sl(".categoryContainer"),
                sidebar: this.sl(".sidebar"),
                sidebarItems: this.slAll(".sidebar div"),
                categories: this.sl(".categories"),
                categoriesHeader: this.sl(".categoriesHeader"),
                categoriesLabel: this.sl(".categoriesLabel"),
            },
